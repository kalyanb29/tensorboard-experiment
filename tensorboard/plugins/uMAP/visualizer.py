...
from tensorboard.plugins.uMAP.shared_config import SECTION_HEIGHT,\
  IMAGE_WIDTH, DEFAULT_CONFIG, SECTION_INFO_FILENAME
from tensorboard.plugins.uMAP.file_system_tools import write_pickle
...
class Visualizer(object):
  ...
  def build_frame(self, arrays):
    ...
    arrays = [reducer.fit_transform(a) for a in arrays] if isinstance(arrays, list) else [reducer.fit_transform(arrays)]
