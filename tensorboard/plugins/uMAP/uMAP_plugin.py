...
from tensorboard.plugins.uMAP import file_system_tools
from tensorboard.plugins.uMAP import im_util
from tensorboard.plugins.uMAP import shared_config
...
class uMAPPlugin(base_plugin.TBPlugin):
  """
  ...
  def get_plugin_apps(self):
    return {
        ...
        '/uMAP-frame': self._serve_uMAP_frame,
  ...
  def is_config_writable(self):
    try:
      ...
      tf.logging.warning(
          'Unable to write uMAP config, controls will be disabled: %s', e)
      return False
  ...
  @wrappers.Request.application
  def _serve_uMAP_frame(self, request): # pylint: disable=unused-argument
